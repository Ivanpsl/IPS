...
public class Main {
	...
	public static void main(String[] args) throws IOException, ParseException {
		g = new Gestor();
		Atleta javier = new Atleta("666", "Javier Castro", new Date(95, 10, 17), 0);
		g.añadirInscripcionEvento(javier, g.getEventos().get(0));
	...
	private static void mostrarComandosDisponibles() {
		while (ejecucion) {
			...
			System.out.println(
					"mostrarInformacionDNI - DNI -> Muestra los eventos a los que se ha inscrito alguien con ese DNI");
