...
public class Gestor {
	...
	/**
	 * Pasar el número de cuenta al usuario para que pueda pagar, viene en un
	...
	/**
	 * Asignación de dorsales a partir del 10. Antes de ello se ordenan los
	 * inscritos por fecha de inscripción y estado del pago.
	 */
	...
	/***
	 * Metodo usado para crear eventos y añadirlos tanto al array como a la base
	 * de datos
	 * 
	 * @param nombre
	 * @param tipo
	 ...
	 *            lista a filtrar
	 * @param distancia:
	 *            si es true añade filtro de distancias
	 * @param maxDistancia:
	 ...
	 * @param terminados:
	 *            si es true se añade filtro para eventos terminados
	 * @param plCerrada:
	 *            si es true se añade filtro para plazos cerrados
	 * @param plzLlenas:
	 *            si es true se añade el filtro para filtrar plazas llenas
